...
class ConfigurationApi(object):
    ...
    def put_config(self, inline_object10, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_config(inline_object10, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_config_with_http_info(inline_object10, **kwargs)  # noqa: E501

    def put_config_with_http_info(self, inline_object10, **kwargs):  # noqa: E501
        """put_config  # noqa: E501

        Provides general information about the manager's topology, license state and  checksums and allows you to set the topology name.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_config_with_http_info(inline_object10, async_req=True)
        >>> result = thread.get()
        ...
        if ('inline_object10' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object10` when calling `put_config`")  # noqa: E501
    ...
    def put_keyset(self, inline_object12, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_keyset(inline_object12, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_keyset_with_http_info(inline_object12, **kwargs)  # noqa: E501

    def put_keyset_with_http_info(self, inline_object12, **kwargs):  # noqa: E501
        """put_keyset  # noqa: E501

        Generates or fetches cryptographic credentials which are used to provide overlay devices access to the topology.  Keyset generation happens in background. Poll on GET /keyset in_progress value.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_keyset_with_http_info(inline_object12, async_req=True)
        >>> result = thread.get()
        ...
        if ('inline_object12' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object12` when calling `put_keyset`")  # noqa: E501
    ...
    def put_update_admin_ui(self, inline_object8, **kwargs):  # noqa: E501
        """put_update_admin_ui  # noqa: E501

        Update Admin UI settings. Enable/Disable and set credentials.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_update_admin_ui(inline_object8, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_update_admin_ui_with_http_info(inline_object8, **kwargs)  # noqa: E501

    def put_update_admin_ui_with_http_info(self, inline_object8, **kwargs):  # noqa: E501
        """put_update_admin_ui  # noqa: E501

        Update Admin UI settings. Enable/Disable and set credentials.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_update_admin_ui_with_http_info(inline_object8, async_req=True)
        >>> result = thread.get()
        ...
        if ('inline_object8' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object8` when calling `put_update_admin_ui`")  # noqa: E501
    ...
    def put_update_api_password(self, inline_object9, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_update_api_password(inline_object9, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_update_api_password_with_http_info(inline_object9, **kwargs)  # noqa: E501

    def put_update_api_password_with_http_info(self, inline_object9, **kwargs):  # noqa: E501
        """put_update_api_password  # noqa: E501

        Allows you to change the API password/secret key.  To change the Web UI password (or username) use PUT admin_ui.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_update_api_password_with_http_info(inline_object9, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['inline_object9']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('inline_object9' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object9` when calling `put_update_api_password`")  # noqa: E501
    ...
    def put_upload_ssl_keypair(self, inline_object11, **kwargs):  # noqa: E501
        """put_upload_ssl_keypair  # noqa: E501

        Upload new SSL cert and key pair  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_upload_ssl_keypair(inline_object11, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_upload_ssl_keypair_with_http_info(inline_object11, **kwargs)  # noqa: E501

    def put_upload_ssl_keypair_with_http_info(self, inline_object11, **kwargs):  # noqa: E501
        """put_upload_ssl_keypair  # noqa: E501

        Upload new SSL cert and key pair  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_upload_ssl_keypair_with_http_info(inline_object11, async_req=True)
        >>> result = thread.get()
        ...
        if ('inline_object11' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object11` when calling `put_upload_ssl_keypair`")  # noqa: E501
