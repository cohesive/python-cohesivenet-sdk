...
class SystemAdministrationApi(object):
    ...
    def get_task_status(self, inline_object7, **kwargs):  # noqa: E501
        """get_task_status  # noqa: E501

        Describe task status details  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_task_status(inline_object7, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_task_status_with_http_info(inline_object7, **kwargs)  # noqa: E501

    def get_task_status_with_http_info(self, inline_object7, **kwargs):  # noqa: E501
        """get_task_status  # noqa: E501

        Describe task status details  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_task_status_with_http_info(inline_object7, async_req=True)
        >>> result = thread.get()
        ...
        if ('inline_object7' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object7` when calling `get_task_status`")  # noqa: E501
