...
class RoutingApi(object):
    ...
    def post_create_route(self, inline_object29, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_create_route(inline_object29, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_create_route_with_http_info(inline_object29, **kwargs)  # noqa: E501

    def post_create_route_with_http_info(self, inline_object29, **kwargs):  # noqa: E501
        """post_create_route  # noqa: E501

        Pushes routes that this manager has access to via its network interfaces (virtual or otherwise)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_create_route_with_http_info(inline_object29, async_req=True)
        >>> result = thread.get()
        ...
        if ('inline_object29' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object29` when calling `post_create_route`")  # noqa: E501
