...
class BGPApi(object):
    ...
    def post_create_ipsec_endpoint_bgp_peer(self, endpoint_id, inline_object32, **kwargs):  # noqa: E501
        """post_create_ipsec_endpoint_bgp_peer  # noqa: E501

        Create BGP peer connection  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_create_ipsec_endpoint_bgp_peer(endpoint_id, inline_object32, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_create_ipsec_endpoint_bgp_peer_with_http_info(endpoint_id, inline_object32, **kwargs)  # noqa: E501

    def post_create_ipsec_endpoint_bgp_peer_with_http_info(self, endpoint_id, inline_object32, **kwargs):  # noqa: E501
        """post_create_ipsec_endpoint_bgp_peer  # noqa: E501

        Create BGP peer connection  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_create_ipsec_endpoint_bgp_peer_with_http_info(endpoint_id, inline_object32, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['endpoint_id', 'inline_object32']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('inline_object32' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object32` when calling `post_create_ipsec_endpoint_bgp_peer`")  # noqa: E501
    ...
    def put_edit_ipsec_endpoint_bgp_peer(self, endpoint_id, bgp_peer_id, inline_object33, **kwargs):  # noqa: E501
        """put_edit_ipsec_endpoint_bgp_peer  # noqa: E501

        Edit BGP peer connection parameters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_edit_ipsec_endpoint_bgp_peer(endpoint_id, bgp_peer_id, inline_object33, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int endpoint_id: ID for IPsec endpoint (required)
        :param int bgp_peer_id: ID for BGP peer (required)
        :param InlineObject33 inline_object33: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_edit_ipsec_endpoint_bgp_peer_with_http_info(endpoint_id, bgp_peer_id, inline_object33, **kwargs)  # noqa: E501

    def put_edit_ipsec_endpoint_bgp_peer_with_http_info(self, endpoint_id, bgp_peer_id, inline_object33, **kwargs):  # noqa: E501
        """put_edit_ipsec_endpoint_bgp_peer  # noqa: E501

        Edit BGP peer connection parameters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_edit_ipsec_endpoint_bgp_peer_with_http_info(endpoint_id, bgp_peer_id, inline_object33, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['endpoint_id', 'bgp_peer_id', 'inline_object33']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('inline_object33' not in local_var_params or
                local_var_params['inline_object33'] is None):
            raise ApiValueError("Missing the required parameter `inline_object33` when calling `put_edit_ipsec_endpoint_bgp_peer`")  # noqa: E501
