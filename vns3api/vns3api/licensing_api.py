...
class LicensingApi(object):
    ...
    def put_set_license_parameters(self, inline_object9, **kwargs):  # noqa: E501
        """put_set_license_parameters  # noqa: E501

        Set and accept license parameters. Triggers reboot. Irreversible operation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_set_license_parameters(inline_object9, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_set_license_parameters_with_http_info(inline_object9, **kwargs)  # noqa: E501

    def put_set_license_parameters_with_http_info(self, inline_object9, **kwargs):  # noqa: E501
        """put_set_license_parameters  # noqa: E501

        Set and accept license parameters. Triggers reboot. Irreversible operation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_set_license_parameters_with_http_info(inline_object9, async_req=True)
        >>> result = thread.get()
        ...
        if ('inline_object9' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `inline_object9` when calling `put_set_license_parameters`")  # noqa: E501
