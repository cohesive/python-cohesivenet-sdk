...
class InlineObject42(object):
    ...
    @property
    def cidr(self):
        """Gets the cidr of this InlineObject42.  # noqa: E501
        ...
        :return: The cidr of this InlineObject42.  # noqa: E501
        :rtype: str
        """
        return self._cidr
    ...
    @cidr.setter
    def cidr(self, cidr):
        """Sets the cidr of this InlineObject42.

        CIDR of a route that the VNS3 Controller has access  to that it wants to publish throughout the  Routing tables of the overlay network   # noqa: E501

        :param cidr: The cidr of this InlineObject42.  # noqa: E501
        :type: str
        """
        if cidr is None:
    ...
    @property
    def interface(self):
        """Gets the interface of this InlineObject42.  # noqa: E501

        Sets the interface where this route will be advertised.  # noqa: E501

        :return: The interface of this InlineObject42.  # noqa: E501
        :rtype: str
        """
    ...
    def interface(self, interface):
        """Sets the interface of this InlineObject42.

        Sets the interface where this route will be advertised.  # noqa: E501

        :param interface: The interface of this InlineObject42.  # noqa: E501
        :type: str
        """
    ...
    @property
    def gateway(self):
        """Gets the gateway of this InlineObject42.  # noqa: E501

        If interface is set, a specific gateway address reachable from that interface  # noqa: E501

        :return: The gateway of this InlineObject42.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway(self, gateway):
        """Sets the gateway of this InlineObject42.

        If interface is set, a specific gateway address reachable from that interface  # noqa: E501

        :param gateway: The gateway of this InlineObject42.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tunnel(self):
        """Gets the tunnel of this InlineObject42.  # noqa: E501

        numerical reference for the GRE endpoint id (must provide either tunnel OR interface)  # noqa: E501

        :return: The tunnel of this InlineObject42.  # noqa: E501
        :rtype: int
        """
        return self._tunnel
    ...
    def tunnel(self, tunnel):
        """Sets the tunnel of this InlineObject42.

        numerical reference for the GRE endpoint id (must provide either tunnel OR interface)  # noqa: E501

        :param tunnel: The tunnel of this InlineObject42.  # noqa: E501
        :type: int
        """
    ...
    @property
    def advertise(self):
        """Gets the advertise of this InlineObject42.  # noqa: E501

        advertise route to overlay network  # noqa: E501

        :return: The advertise of this InlineObject42.  # noqa: E501
        :rtype: bool
        """
    ...
    def advertise(self, advertise):
        """Sets the advertise of this InlineObject42.

        advertise route to overlay network  # noqa: E501

        :param advertise: The advertise of this InlineObject42.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def metric(self):
        """Gets the metric of this InlineObject42.  # noqa: E501

        weight for route  # noqa: E501

        :return: The metric of this InlineObject42.  # noqa: E501
        :rtype: int
        """
        return self._metric
    ...
    def metric(self, metric):
        """Sets the metric of this InlineObject42.

        weight for route  # noqa: E501

        :param metric: The metric of this InlineObject42.  # noqa: E501
        :type: int
        """
