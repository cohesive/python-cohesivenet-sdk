...
class SnapshotsApi(object):
    ...
    def delete_snapshot(self, snapshot_name, **kwargs):  # noqa: E501
        ...
        return self.delete_snapshot_with_http_info(snapshot_name, **kwargs)  # noqa: E501
    ...
    def delete_snapshot_with_http_info(self, snapshot_name, **kwargs):  # noqa: E501
        ...
        if ('snapshot_name' not in local_var_params or
                local_var_params['snapshot_name'] is None):
            raise ApiValueError("Missing the required parameter `snapshot_name` when calling `delete_snapshot`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'snapshot_name' in local_var_params:
            path_params['snapshot_name'] = local_var_params['snapshot_name']  # noqa: E501
    ...
    def get_download_snapshot(self, snapshot_name, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_download_snapshot_with_http_info(snapshot_name, **kwargs)  # noqa: E501

    def get_download_snapshot_with_http_info(self, snapshot_name, **kwargs):  # noqa: E501
        """get_download_snapshot  # noqa: E501
        ...
        if ('snapshot_name' not in local_var_params or
                local_var_params['snapshot_name'] is None):
            raise ApiValueError("Missing the required parameter `snapshot_name` when calling `get_download_snapshot`")  # noqa: E501
