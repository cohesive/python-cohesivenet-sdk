...
class SnapshotsApiRouter(VersionRouter):
    function_library = {
        "delete_snapshot": {"4.8.4-5.0.8": delete_snapshot},
        "get_download_snapshot": {"4.8.4-5.0.8": get_download_snapshot},
        "get_snapshots": {"4.8.4-5.0.8": get_snapshots},
        "post_create_snapshot": {"4.8.4-5.0.8": post_create_snapshot},
        "put_import_snapshot": {"4.8.4-5.0.8": put_import_snapshot},
    }
