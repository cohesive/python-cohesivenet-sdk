...
class BackupsApiRouter(VersionRouter):
    ...
    function_library = {
        "get_backups": {"2.1.1": get_backups},
        "delete_backup": {"2.1.1": delete_backup},
        "get_download_backup": {"2.1.1": get_download_backup},
        "post_upload_backup": {"2.1.1": post_upload_backup},
        "post_create_backup": {"2.1.1": post_create_backup},
        "get_backup_job": {"2.1.1": get_backup_job},
        "post_restore_backup": {"2.1.1": post_restore_backup},
        "get_snapshots_backup": {"2.1.1": get_snapshots_backup},
        "delete_snapshots_backup": {"2.1.1": delete_snapshots_backup},
        "get_download_snapshots_backup": {"2.1.1": get_download_snapshots_backup},
        "post_upload_snapshots_backup": {"2.1.1": post_upload_snapshots_backup},
