...
class SystemApiRouter(VersionRouter):
    ...
    function_library = {
        ...
        "get_credential_type_details": {"2.1.1": get_credential_type_details},
        "get_system_ntp_hosts": {"2.1.1": get_system_ntp_hosts},
        "post_add_ntp_host": {"2.1.1": post_add_ntp_host},
        "delete_ntp_host": {"2.1.1": delete_ntp_host},
        "delete_ssl_install": {"2.1.1": delete_ssl_install},
